...
class RelToParentFrom(six.with_metaclass(OneToOneFormMetaClass,
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(RelToParentFrom, self).__init__(*args, **kwargs)
    ...
    def save(self, commit=True):
        ...
        return super(RelToParentFrom, self).save(commit=commit)
